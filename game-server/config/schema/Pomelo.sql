...
CREATE TABLE IF NOT EXISTS `Bag` (
  ...
  `items` varchar(5000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS `FightSkill` (
  ...
  `type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `INDEX_PLAYER_ID` (`playerId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `Player` (
  ...
  `kindId` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT '0002',
  ...
  `kindName` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'god soilder',
...
CREATE TABLE IF NOT EXISTS `Task` (
  ...
  `taskData` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT '{}',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `User` (
  ...
  `from` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
